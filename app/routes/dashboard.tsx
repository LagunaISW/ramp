...
const navigation = [
  ...
  { name: "CreditCard", href: "/dashboard/CreditCard", icon: FolderIcon, current: false },
  { name: "Analyst", href: "/dashboard/Analyst", icon: FolderIcon, current: false },
  { name: "Client", href: "/dashboard/Client", icon: FolderIcon, current: false },
];
